...
export default function AbmIglesia({id_iglesia, finalizarAltaOcopia,esModal,id_copia, usuario}){
...
useEffect(()=>{
    ...
    if (tablasCargadas ){ // este useEffect se dispara solo si ya se cargaron las tablas generales
        ...
        if (id_iglesia){ //  si se recibió el nùmero de alumno por propiedad es decir si es una modificación
            ...
            setTituloAbm(`Editar la iglesia #${id_iglesia}`);
                    ...
                    <div className="flex f-col">
                        <div className="flex f-col el-abm-sel-pos">
                            <div className="flex f-row">
                                ...
                                <span title="Buscar provincias" onClick={()=>{setBuscarProvincias(true);toggle()}} className="cursor-pointer acciones-lista-cabecera botonNc ml-6" >
        ...
        */}
                ...
                <div className="flex f-col">
                    ...
                    <div className="flex f-col">
                        ...
                        { values.nombre_encargado !="" && <span title="Aceptar el nombre ingresado. No es obrero UAD" onClick={()=>{cerrarBusquedaPastor()}} className="cursor-pointer boton-aceptar ml-6 mt-4 mb-4" >
                                Aceptar 
                            </span>}   
